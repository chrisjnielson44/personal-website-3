...
export const techIcons: Record<string, TechIcon> = {
  ...
  pydantic: toEmblem(siPydantic),
  pandas: toEmblem(siPandas),
  numpy: toEmblem(siNumpy),
  jupyter: toEmblem(siJupyter),
  timescaledb: toEmblem(siTimescale),
  prisma: toEmblem(siPrisma),
  tanstack: toEmblem(siTanstack),
  tailwind: toEmblem(siTailwindcss),
  git: toEmblem(siGit),
};
